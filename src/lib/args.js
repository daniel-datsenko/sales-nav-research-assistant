...
function parseCliArgs(argv) {
  ...
  const { values, positionals } = parseArgs({
    ...
    options: {
      ...
      'browser-activity-profile': { type: 'string' },
      'max-browser-jobs-per-run': { type: 'string' },
      'min-browser-job-delay-ms': { type: 'string' },
      'rate-limit-cooldown-ms': { type: 'string' },
      'reuse-sweep-cache': { type: 'boolean' },
      'adaptive-sweep-pruning': { type: 'boolean' },
      'api-read-prefetch': { type: 'boolean' },
      'api-prefetch-lead-count': { type: 'string' },
      'deep-profile-pass': { type: 'boolean' },
      'profile-read-method': { type: 'string' },
      'deep-profile-limit': { type: 'string' },
      'force-deep-profile-pass': { type: 'boolean' },
      'scaleup-selection-expanded': { type: 'boolean' },
      'strict-voyager-promotion': { type: 'boolean' },
      'report-voyager-identity-gaps': { type: 'boolean' },
      'run-experiments': { type: 'boolean' },
      'sales-nav-lead-url': { type: 'string' },
      'public-profile-url': { type: 'string' },
