...
(function() {
  ...
  var cards = document.querySelectorAll(
    'article[data-at="job-item"], [data-genesis-element="JOB_CExample Broadcaster"], article.sc-fhzFiK'
  );
  var out = [];
  for (var i = 0; i < cards.length; i++) {
    var c = cards[i];
...
for page in range(1, 4):   # pages 1-3
    ...
    batch_json = js("""
    (function() {
      var cards = document.querySelectorAll('article[data-at="job-item"], [data-genesis-element="JOB_CExample Broadcaster"]');
      var out = [];
      for (var i = 0; i < cards.length; i++) {
        var c = cards[i];
